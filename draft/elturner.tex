...
% TODO elaborate on localization errors
...
% TODO elaborate on time synchronization errors
...
% TODO elaborate on sensor errors
...
\begin{equation}
	...
	\label{eq:carvemap}
\end{equation}
% TODO expand on the description of this
...
% wedge generation
% (don't need to talk about that) TODO YES WE DO
...
\begin{figure}
	\centerline{\includegraphics[width=1.0\linewidth]{procarve/process/plane_intersection/plane_xtion_diagram}}
...
\subsection{Comparison to Previous Method}
\label{ssec:compare_3dv2013_procarve}

% TODO add figure comparing siggraph and turner13
