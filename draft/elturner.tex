...
\begin{figure}
	...
	\centerline{\includegraphics[width=1.0\linewidth]{3dv2013/results/snapshot_newparkmall00_cropped.jpg}}
	\centerline{(a)}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.55\linewidth}
	\centerline{\includegraphics[width=1.0\linewidth]{3dv2013/results/newparkmall.png}}
	\centerline{(b)}
	\end{minipage}
